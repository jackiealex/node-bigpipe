var AppBaseController, ForeRunner, Gaze, config, express, mail, os, path, renderer, socket_redis, _,
  __slice = [].slice;
...
AppBaseController = (function() {
  ...
  AppBaseController.prototype.start = function(cb) {
    var SocketIOCookieParser, auth_pass, host, ih, io, port, pub, redis, server, sub, _i, _len, _ref;
    if (cb == null) {
      cb = function() {};
    }
    ...
    if (GLOBAL_OBJECT['mode'] !== 'development') {
      auth_pass = '883c9402e3d21858d02ef66a97d50affd7d7af98a9862181f426236cf22eef93';
