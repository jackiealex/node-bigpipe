...
$_output_ += '\n\t\t<div class="column add-type" back><i class="add middle icon"></i>添加</div>\n\t\t</div>\n\t\t<div class="row" style="margin-top: 30px;">\n\t\t\t<div class="ui btn-submit primary button">提交</div>\n\t\t</div>\n\t</form>\n</div>\n<link rel="stylesheet" href="http://7xlphm.com1.z0.glb.clouddn.com/static/css/lib/animate-e78c4ece.css">\n<script type="text/javascript" src="http://7xlphm.com1.z0.glb.clouddn.com/static/js/mod/stickers/publish-3ab7f3fe.js"></script>';
}
