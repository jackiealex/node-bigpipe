...
exports.view = function(req, res) {
  var pageletLayout;
  return pageletLayout = new Pagelet(res, {
    autoEnd: true,
...
exports.layout = function(req, res) {
  var pageletA, pageletA1, pageletA2, pageletA2Children1, pageletA2Children2, pageletB, pageletLayout, pageletManager;
  ...
  pageletA2Children1 = new Pagelet(res, {
    autoEnd: false,
    template: 'pagelet/test/a-2-children1.html',
    selector: '.a-2-children1'
  });
  pageletA2Children2 = new Pagelet(res, {
    autoEnd: false,
    template: 'pagelet/test/a-2-children2.html',
...
exports.delay1 = function(req, res) {
  var pageletLayout;
  pageletLayout = new Pagelet(res, {
    template: 'pagelet/test/delay1.html'
  });
  return pageletLayout.pipe();
};
...
exports.delay2 = function(req, res) {
  var pageletLayout;
  pageletLayout = new Pagelet(res, {
    template: 'pagelet/test/delay2.html'
  });
  return pageletLayout.pipe();
};
...
exports.tmpl = function(req, res) {
  var pageletLayout;
  pageletLayout = new Pagelet(res, {
    template: 'pagelet/test/tmpl.html',
    data: {
      xx: 'oo'
    }
  });
