define(function() {
    ...
    return {
        init: function() {
            ...
            socket.on('push_users_count', function(rs) {
            ...
            $scope.on('click', '.btn-users-count', function(e) {
                socket.emit('request_users_count');
            });
